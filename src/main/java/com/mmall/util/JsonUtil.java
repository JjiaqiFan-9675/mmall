...
public class JsonUtil {
    ...
    //注意 序列化和反序列化后信息虽然一致，但是地址不同
    //List<User> 反序列化后返回的是List<LinkedList>不是List<user>,因此用下面的方法
...
//        User user = new User();
//        user.setId(2);
//        user.setEmail("jiaqi1@happymmall.com");
...
//        User u2 = new User();
//        u2.setId(2);
//        u2.setEmail("jaiqi2@happymmall.com");
//
//
//
